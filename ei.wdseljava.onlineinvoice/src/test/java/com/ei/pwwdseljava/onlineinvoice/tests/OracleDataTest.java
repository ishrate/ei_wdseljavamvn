...
public class OracleDataTest {
    ...
    public void testDatabaseData(String query, String expectedValue) {
        ...
        assertTrue(result.contains(expectedValue), "Data from DB: " + result + " does not contain expected value: " + expectedValue);
    }

    @DataProvider(name = "oracleData")
    public Object[][] getOracleData() {
        return new Object[][]{
            {"SELECT * FROM your_table WHERE condition = 'value'", "expected_value_1"},
    ...
    public Object[][] getInvoiceData() {
        return new Object[][]{
            {20454801} // Test with Invoice ID 101
